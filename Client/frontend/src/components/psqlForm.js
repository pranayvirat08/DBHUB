...
export default function Details() {
  ...
  const handleClick = (event) => {
    ...
    axios.defaults.baseURL = "http://52.87.250.227:3000"
    axios
  ...
  const handleClick1 = async (event) => {
    try {
      event.preventDefault();
      const response = await axios.get('http://52.87.250.227:3000/api/db/downloadPostgres',{
       params:{
         fileType: type,
       },
       responseType: 'blob',
        ...
        <Card style={{
          ...
          <Card.Body>
            ...
            <Card.Text>
              ...
              <h4>Parameters</h4>
              <ul>
                <li><b>URL: </b> <p>The JDBC URL for PostgreSQL is a string that specifies the address of the database server, along with any necessary parameters for connecting to the database. Here is an example JDBC URL for connecting to a PostgreSQL database:<b>jdbc:postgresql://http://52.87.250.227/:5432/mydatabase</b></p><p>In this example, http://52.87.250.227/ is the hostname or IP address of the server where the PostgreSQL database is running, 5432 is the port number on which the database is listening for connections, and mydatabase is the name of the database you want to connect to. You may need to replace http://52.87.250.227/ with the actual hostname or IP address of your server, and mydatabase with the name of your own database. 
                </p></li>
