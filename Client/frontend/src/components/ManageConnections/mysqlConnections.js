...
const MySQLConnections = () =>{
    ...
    const getConnections = async() =>{
        try{
            const result = await axios.get("http://52.87.250.227:3000/api/db/mysql/getDetails");
    ...
    const updateConnections = async (e) =>{
        e.preventDefault();
        try{
            const res = await axios.put(`http://52.87.250.227:3000/api/db/mysql/getDetails/${isUpdated}`,{url: updatedUrl, username: updatedUsername, password: updatePassword} )
    ...
    const deleteConnections = async(id) =>{
        try{
        const res = await axios.delete(`http://52.87.250.227:3000/api/db/mysql/getDetails/${id}`);
