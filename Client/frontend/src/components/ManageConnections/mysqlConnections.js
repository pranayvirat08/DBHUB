...
const MySQLConnections = () =>{
    ...
    const getConnections = async() =>{
        try{
            const result = await axios.get("http://http://34.228.30.99/:3000/api/db/mysql/getDetails");
    ...
    const updateConnections = async (e) =>{
        e.preventDefault();
        try{
            const res = await axios.put(`http://http://34.228.30.99/:3000/api/db/mysql/getDetails/${isUpdated}`,{url: updatedUrl, username: updatedUsername, password: updatePassword} )
    ...
    const deleteConnections = async(id) =>{
        try{
        const res = await axios.delete(`http://http://34.228.30.99/:3000/api/db/mysql/getDetails/${id}`);
