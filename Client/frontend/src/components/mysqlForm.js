...
export default function Details() {
  ...
  const handleClick1 = async (event) => {
    try {
      event.preventDefault();
      const response = await axios.get('http://http://34.228.30.99/:3000/api/db/downloadMySQL',{
       params:{
         fileType: type,
       },
       responseType: 'blob',
        ...
        <Card style={{ width: '60rem', backgroundColor: '#C3EEFA' }}>
          ...
          <Card.Body>
            ...
            <Card.Text>
              ...
              <h4>Parameters</h4>
              <ul>
                <li><b>URL:</b><p>JDBC URL: The JDBC URL for MySQL usually looks like this: <b>jdbc:mysql://http://34.228.30.99/:3306/dbname </b>, where http://34.228.30.99/ is the name of the server where MySQL is running, 3306 is the port number, and dbname is the name of the database you want to connect to. You will need to replace http://34.228.30.99/ and dbname with the appropriate values for your MySQL setup.</p></li>
