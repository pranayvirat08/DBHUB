...
if(checkedJSON){
 ...
 axios.defaults.baseURL =  "http://http://34.228.30.99/:3000/api/aws" //"http://localhost:3000/api/aws"
...
const handleClick = async (event) => {
  try {
    event.preventDefault();
    const response = await axios.get('http://http://34.228.30.99/:3000/api/aws/aws/download',{
     params:{
       fileType: type,
     },
     responseType: 'blob',
